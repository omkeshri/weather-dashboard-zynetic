...
const ForeCastCard = ({time, date, city, temp, icon}) => {
  return (
    <div className="flex flex-col items-center px-4 py-3  rounded-xl opacity-100 hover:bg-neutral-800 cursor-pointer">
      <h3 className="text-[10px] font-semibold  tracking-wide ">{time}</h3>
      <h3 className="text-[10px] font-semibold  tracking-wide">{date}</h3>
      <h3 className="text-[10px] font-semibold  tracking-wider text-center">{city}</h3>
